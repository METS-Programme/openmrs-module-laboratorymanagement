...
import org.openmrs.module.labmanagement.tasks.*;
 ...
 */
public class LabManagementActivator extends BaseModuleActivator {
	 ...
	 */
	public void started() {
		log.info("Starting Lab Management");
		...
		log.info("Started Lab Management");
	}
	...
	public void shutdown() {
		log.info("Shutdown Lab Management");
	}
